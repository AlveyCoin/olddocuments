...
Alvey-qt devuelve "nulo" después de cada uno (ver Figura 6).
...
3. "monto" (numérico o cadena, opcional) El monto en ALVEY para enviar, predeterminado: 0
4. gasLimit (numérico o cadena, opcional) gasLimit, predeterminado: 250000, máx .: 40000000
5. gasPrice (numérico o cadena, opcional) gasPrice ALVEY precio por unidad de gas, predeterminado: 0.0000004, min: 0.0000004
6. "senderaddress" (cadena, opcional) La dirección Alvey que se utilizará como remitente
...
OBSOLETO. Asigna y nombre de cuenta a la dirección dada. Alvey-qt devolverá "nulo" si tiene éxito.
...
Establezca la tarifa de transacción por kilobyte del mensaje de transacción. Sobrescribe el parámetro paytxfee visto en `getwalletinfo`. La tarifa mínima predeterminada por 1,000 bytes es 0.004 ALVEY. Devuelve verdadero si tiene éxito.
...
Comando oculto Espera a que se completen todas las filas de validación asincrónicas (para blockchain, mempool, etc.). Para uso de los desarrolladores. Alvey-qt devuelve "nulo", alveyd no devuelve nada.
...
Comando oculto Se usa para monitorear cuando la recarga de blockchain ha alcanzado un bloque determinado. Para interfaces de línea de comandos como alveyd (no para la billetera GUI alvey-qt), el comando regresa después de cargar el bloque dado. Este ejemplo espera el bloque Mainnet 150,000:
...
alvey-cli no devuelve ninguna respuesta, pero puede verificar con `getwalletinfo` para" unlocked_until ": 0 y verificar el icono del candado en alvey-qt.
...
La billetera alvey-qt mostrará el estado de bloqueo con el icono del candado y la consola devolverá "nulo". alvey-cli no devuelve ningún estado, pero puede verificar el estado de desbloqueo con `getwalletinfo` para" unlocked_until ":

### walletpassphrasechange "oldpassphrase" "newpassphrase"

Cambia la frase de contraseña de la billetera de "oldpassphrase" a "newpassphrase", alvey-qt devuelve "null", alveyd no devuelve nada.
...
[
](https://docs.alvey.site/en/Adding-Nodes/)