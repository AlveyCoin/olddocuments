...
* [Launching Alvey Core as a Super Staker](#launching-alvey-core-as-a-super-staker)
...
Delegation of addresses may also be accomplished using the Alvey Electrum wallet, which supports Ledger hardware wallet addresses.
...
The Alvey Core wallet may be launched as a Super Staker with Alvey-Qt using Settings - Options – Main – Enable super staking steps as shown above, or directly through the command line using the `-superstaking` parameter (testnet shown here).
